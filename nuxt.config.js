export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:image', property: 'og:image', content: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Apple_Computer_Logo_rainbow.svg' },
  ...
  // @nuxtjs/style-resources 모든 파일에 이 파일 가져와서 적용
  styleResources: {
    scss: [
      '~/scss/main.scss'
    ]
  ...
  build: {
    babel: {
      ...
      plugins: [
        ['@babel/plugin-transform-runtime'] // regenerator-runtime 대신 사용
      ]
    },
    postcss: {
      plugins: [
